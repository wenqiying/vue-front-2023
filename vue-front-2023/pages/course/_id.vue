                      ...
                      <menu id="lh-menu" class="lh-menu mt10 mr10">
                        <ul>
                          ...
                          <li class="lh-menu-stair" v-for="chapter in chapterVideoList" :key="chapter.id">
                            <a href="javascript: void(0)" :title="chapter.id" class="current-1">
...
export default {
  ...
  methods: {
    initCourseInfo(){
      course.getBaseCourseInfo(this.courseId).then(res => {
        this.courseWebVo = res.data.courseWebVo
        this.chapterVideoList = res.data.chapterVideoList
        this.isBuy = res.data.isBuy
      })
    },
    createOrders() {
      orders.createOrders(this.courseId).then(res => {
    ...
    initComment() {
      comment.getCommentList(this.page, this.limit, this.courseId).then(res => {
